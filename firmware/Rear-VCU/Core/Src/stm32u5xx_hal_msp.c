...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = SUPP_BATT_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SUPP_BATT_V_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PC5     ------> ADC4_IN23
    */
    GPIO_InitStruct.Pin = THROTTLE_V_Pin|REGEN_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(SUPP_BATT_V_GPIO_Port, SUPP_BATT_V_Pin);
  ...
  else if(hadc->Instance==ADC4)
  {
    ...
    PC5     ------> ADC4_IN23
    */
    HAL_GPIO_DeInit(GPIOC, THROTTLE_V_Pin|REGEN_V_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  */
    ...
    PA5     ------> DAC1_OUT2
    */
    GPIO_InitStruct.Pin = THROTTLE_OUT_Pin|REGEN_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  if(hdac->Instance==DAC1)
  {
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, THROTTLE_OUT_Pin|REGEN_OUT_Pin);
