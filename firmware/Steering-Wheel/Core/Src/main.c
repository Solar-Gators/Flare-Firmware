...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, EEPROM_CS_Pin|BUTTON8_LED_Pin|BUTTON2_LED_Pin|SCREEN_WRITE_READY_Pin
                          |SCREEN_CMD_DATA_SEL_Pin|OK_LED_Pin|ERROR_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SCREEN_D0_Pin|SCREEN_D1_Pin|SCREEN_D2_Pin|SCREEN_D3_Pin
                          |SCREEN_D4_Pin|SCREEN_D5_Pin|SCREEN_D6_Pin|SCREEN_D7_Pin
                          |SCREEN_DC_SEL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, BUTTON1_LED_Pin|BUTTON6_LED_Pin|BUTTON7_LED_Pin|BUTTON4_LED_Pin
                          |BUTTON3_LED_Pin|BUTTON5_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SCREEN_PARALLEL_CS_GPIO_Port, SCREEN_PARALLEL_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : REGEN_INCREASE_Pin REGEN_DECREASE_Pin */
  GPIO_InitStruct.Pin = REGEN_INCREASE_Pin|REGEN_DECREASE_Pin;
  ...
  GPIO_InitStruct.Pin = BUTTON1_Pin|BUTTON2_Pin|BUTTON6_Pin|BUTTON7_Pin
                          |BUTTON8_Pin|BUTTON4_Pin|BUTTON3_Pin|BUTTON5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : BUTTON1_LED_Pin BUTTON6_LED_Pin BUTTON7_LED_Pin BUTTON4_LED_Pin
                           BUTTON3_LED_Pin BUTTON5_LED_Pin */
  GPIO_InitStruct.Pin = BUTTON1_LED_Pin|BUTTON6_LED_Pin|BUTTON7_LED_Pin|BUTTON4_LED_Pin
                          |BUTTON3_LED_Pin|BUTTON5_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
