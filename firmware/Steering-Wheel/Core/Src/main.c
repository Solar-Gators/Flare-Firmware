...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOC,
                      EEPROM_CS_Pin | BUTTON8_LED_Pin | BUTTON2_LED_Pin | SCREEN_WRITE_READY_Pin |
                          SCREEN_CMD_DATA_SEL_Pin | OK_LED_Pin | ERROR_LED_Pin,
                      GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOA,
                      SCREEN_D0_Pin | SCREEN_D1_Pin | SCREEN_D2_Pin | SCREEN_D3_Pin |
    ...
    HAL_GPIO_WritePin(GPIOB,
                      BUTTON1_LED_Pin | BUTTON6_LED_Pin | BUTTON7_LED_Pin | BUTTON4_LED_Pin |
    ...
    /*Configure GPIO pins : EEPROM_CS_Pin BUTTON8_LED_Pin BUTTON2_LED_Pin OK_LED_Pin
                           ERROR_LED_Pin */
    GPIO_InitStruct.Pin =
        EEPROM_CS_Pin | BUTTON8_LED_Pin | BUTTON2_LED_Pin | OK_LED_Pin | ERROR_LED_Pin;
    ...
    GPIO_InitStruct.Pin = BUTTON1_Pin | BUTTON2_Pin | BUTTON6_Pin | BUTTON7_Pin | BUTTON8_Pin |
                          BUTTON4_Pin | BUTTON3_Pin | BUTTON5_Pin;
